...
#define SF8XXX_NM_UART_PORT_NUM (uart_port_t)CONFIG_SF8XXX_NM_UART_PORT_NUM
#define SF8XXX_NM_UART_BAUDRATE (uart_port_t)CONFIG_SF8XXX_NM_UART_BAUDRATE
#define SF8XXX_NM_UART_TXD (uart_port_t)CONFIG_SF8XXX_NM_UART_TXD
#define SF8XXX_NM_UART_RXD (uart_port_t)CONFIG_SF8XXX_NM_UART_RXD
#define SF8XXX_NM_RESPONSE_TIMEOUT_MS (uart_port_t)CONFIG_SF8XXX_NM_RESPONSE_TIMEOUT_MS
#define SF8XXX_NM_DELAY_BTW_CMDS (uart_port_t)CONFIG_SF8XXX_NM_DELAY_BTW_CMDS
#define SF8XXX_NM_RX_BUF_SIZE (uart_port_t)CONFIG_SF8XXX_NM_RX_BUF_SIZE
#define SF8XXX_NM_TX_BUF_SIZE (uart_port_t)CONFIG_SF8XXX_NM_TX_BUF_SIZE
